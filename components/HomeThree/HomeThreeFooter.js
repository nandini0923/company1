                              ...
                              <div className="footer__widget-content">
                                 <div className="footer__widget-info">
                                    <div className="footer__subscribe footer__subscribe-3">
                                       <p>LearnifyHub University does not discriminate on the basis of race, nationa.</p>
                                       <form action="#">
                           ...
                           <div className="footer__widget footer__widget-3 footer-col-3-2 mb-50">
                              ...
                              <div className="footer__widget-content">
                                 <ul>
                                    ...
                                    <li>
                                       <a href="#">LearnifyHub University</a>
                                    </li>
                                    <li>
                                       <a href="#">Instructor</a>
                                    </li>
                           ...
                           <div className="footer__widget footer__widget-3 footer-col-3-4 mb-50">
                              ...
                              <div className="footer__contact">
                                 <ul>
                                    ...
                                    <li>
                                       <p>International:</p>
                                       <h4><a href="mailto:info@LearnifyHub.com">info@LearnifyHub.com</a></h4>
                                    </li>
                                 </ul>
                              </div>
                           </div>
